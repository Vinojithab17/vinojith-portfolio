...
// import ProfilePic from 'assets/Profile.HEIC';
  ...
  <>
    <Fragment>
      ...
      <Text className={styles.description} data-visible={visible} size="l" as="p">
        I’m Vinojith, currently I am an undergraduate in University of Moratuwa,
        departmant of Computer Science and Engineering.
      </Text>
      {/* <Text className={styles.description} data-visible={visible} size="l" as="p">
        In my spare time I like to practice Brazilian Jiu Jitsu, play video games, and{' '}
        <Link href="/projects/volkihar-knight">make mods</Link>. I’m always down for
